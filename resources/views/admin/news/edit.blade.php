            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action= "{{ action('Admin\NewsController@update') }}" method ="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="tittle">タイトル</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="tittle" value="{{ $news_form->tittle }}">
                        </div>
                    </div>
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="form-text text-info">設定中: {{ $news_form->image_path }}
                        </div> 
